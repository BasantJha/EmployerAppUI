...
class Firestoreconnectivity extends StatefulWidget {
  const Firestoreconnectivity({Key? key}) : super(key: key);
  @override
  State<Firestoreconnectivity> createState() => _FirestoreconnectivityState();
}


class _FirestoreconnectivityState extends State<Firestoreconnectivity> {
